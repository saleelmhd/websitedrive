...
$data = mysqli_query($con,"select * from driving_school_tb;");
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title"> DRIVING SCHOOLS</h4>
              </div>
              <div class="card-body">
...
while($dat = mysqli_fetch_assoc($data)){
  ...
  ?>
                      ...
                      <?php echo $count; ?>
                        ...
                        <?php echo $dat['address'] ?>
                        </td>
                        <td>
                        <?php echo $dat['phone_no'] ?>
                        </td>
                        <td>
                        <img src="./images/<?php echo $dat['img'] ?>" height="120px" width="200px" alt="">
                        </td>
